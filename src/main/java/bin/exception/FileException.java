...
import static bin.apply.file.Information.SYSTEM_PATH;
import static bin.apply.file.Information.getExtension;
...
public class FileException extends RuntimeException {
    ...
    public void printErrorMessage(FileException e, String path) {
        String subMessage = switch (e.getMessage()) {
            ...
            case rightExtension -> "The extension currently readable by OTLanguage is (" + getExtension() + ").";
